...
//This array stores all todos items and then the following for-loop add them to HTML document.
const todos = (localStorage.getItem('todos') ? JSON.parse(localStorage.getItem('todos')) : []);
const completed = (localStorage.getItem('completed-list') ? JSON.parse(localStorage.getItem('completed-list')) : []);

loadItems();

//This function adds the items that are inside the arrays to the lists 'todos' or 'completed'
function loadItems() {
...
//Creates on top of the list a new "li" element which conteins the value inputed inside the textbox whenever the "+" icon is clicked 
...
//This function add items to DOM
...
//This function remove the item when the delete icon is clicked.
function removeItem() {
...
//This function set as completed the to-do task whose complete icon was clicked. 
